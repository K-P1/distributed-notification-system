...
from firebase_admin import messaging, credentials, initialize_app, app_check
from jinja2 import Environment
from uuid import uuid4
from .core.config import settings, logger, api_response
from .core.schema import DeviceType, PushNotification, DeviceToken, TemplateData
...
async def enqueue_notification(payload: dict):
    ...
    try:
        ...
        logger.info("Enqueuing message", exchange=exchange.name, routing_key="push", payload=payload)
        ...
        logger.info("Message enqueued successfully", request_id=request_id, payload=payload)
        return api_response(
            success=True,
